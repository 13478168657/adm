            ...
            <div class="row">
                <div class='col-md-12'>
                    <div class="table-responsive">
                        <form class="form-inline" method="post" enctype="multipart/form-data" action="/instruction/postEdit">
                            {{csrf_field()}}
                            ...
                            <table class="table table-condensed table-add">
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" name="name" class="form-control" style="width:350px;" id="inputPassword2" value="{{$instruction->name}}" placeholder="标题">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" class="form-control" id="inputPassword2" style="width:350px;" name="meta_title" value="{{$instruction->meta_title}}" size="70" maxlength="250" placeholder="网页标题">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" class="form-control" id="inputPassword2" style="width:350px;" value="{{$instruction->meta_keyword}}" name="meta_keyword" value="" style="width:350px;" size="70" placeholder="meta关键字">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <textarea type="text" style="width:350px;height:80px;" class="form-control" id="inputPassword2" value="" name="meta_description" placeholder="meta描述">{{$instruction->meta_description}}</textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea id="editor" name="content" type="text/plain" style="width:720px;height:500px;">{{$instruction->content}}</textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <th></th>
