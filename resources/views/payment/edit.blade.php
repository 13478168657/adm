                        ...
                        <form class="form-inline" method="post" enctype="multipart/form-data" action="/payment/postEdit">
                            ...
                            <table class="table table-condensed table-add">
                                ...
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" class="form-control" id="inputPassword2" style="width:350px;" name="meta_keyword" value="{{$payment->meta_keyword}}"  style="width:350px;" size="70" placeholder="meta关键字">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <textarea type="text" style="width:350px;height:80px;" class="form-control" id="inputPassword2" value="{{$payment->meta_description}}"  name="meta_description" placeholder="meta描述"></textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
