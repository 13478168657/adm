                ...
                <div class="col-md-12">
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                            <a href="/goods/create"><button class="btn btn-success btn-xs pull-right">
                        ...
                        <table class="table table-bordered table-condensed table-hover">
                            ...
                            @foreach($goods as $good)
                                <tr>
                                    ...
                                    <td><a onclick="del(this);" href="javascript:void(0);" data-id="{{$good->id}}">删除</a>／<a href="/goods/edit?id={{$good->id}}">修改</a>／<a href="{{env('WEB_URL')}}/g-{{$good->id}}.html" target="_blank">预览</a></td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
