            ...
            <div class="row">
                <div class='col-md-12'>
                    <div class="table-responsive">
                        <form class="form-inline" method="post" enctype="multipart/form-data" action="/notice/postEdit">
                            {{csrf_field()}}
                            ...
                            <table class="table table-condensed table-add">
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" name="name" class="form-control" id="inputPassword2" value="{{$notice->name}}" placeholder="标题">
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea id="editor" name="content" type="text/plain" style="width:720px;height:500px;">{{$notice->content}}</textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <th></th>
