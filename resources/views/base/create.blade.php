                        ...
                        <form class="form-inline" method="post" enctype="multipart/form-data" action="/base/postCreate">
                            ...
                            <table class="table table-condensed table-add">
                                <tr>
                                    ...
                                    <td style="width:85%;">
                                        <div class="form-group">                                                                <input type="text" name="name" class="form-control" id="inputPassword2" placeholder="名称">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" name="home_key_word" class="form-control" id="inputPassword2" placeholder="关键字">
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" name="home_meta_description" class="form-control" id="inputPassword2" placeholder="描述">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" name="link_style" class="form-control" id="inputPassword2" placeholder="联系方式">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" name="link_mobile" class="form-control" id="inputPassword2" placeholder="联系电话">
                                        </div>
                                    </td>
                                </tr>
